...
import { MdOutlineModeEditOutline, MdOutlineCheckCircleOutline, MdPerson,MdOutlineEmail } from "react-icons/md";
...
// faculty profile
export const FacultyProfile = ({name,image,isUpdated,department,email}) => {
    return (
        <>
            <div className="flex flex-row items-center">
                {/* profile photo */}
                ...
                <div className="ml-3">
                    <div className="flex items-center"><h1 className="text-2xl font-bold text-oirBrown mr-2">{name}</h1><MdOutlineModeEditOutline /> 
                    {isUpdated && (<div className="flex items-center text-green-500 ml-2"> <MdOutlineCheckCircleOutline /><p className="ml-1 text-xs font-bold ">Updated</p> </div>)}</div>
                    <div className="flex items-center text-base font-medium text-gray-600"><BsDot />{department} Department</div>
                    <div className="  flex items-center "><MdOutlineEmail /><p className="text-xs ml-1">{email}</p></div>
                </div>
            </div>
        </>
    );
...
// alumni profile
export const AlumniProfile = ({name,image,isUpdated,country,passYear,email}) => {
    return (
        <>
            <div className="flex flex-row items-center">
                {/* profile photo */}
                ...
                <div className="ml-3">
                    <div className="flex items-center"><h1 className="text-2xl font-bold text-oirBrown mr-2">{name}</h1><MdOutlineModeEditOutline /> 
                    {isUpdated && (<div className="flex items-center text-green-500 ml-2"> <MdOutlineCheckCircleOutline /><p className="ml-1 text-xs font-bold ">Updated</p> </div>)}</div>
                    <div className="flex items-center text-base font-medium text-gray-600"><BsDot />{country}<BsDot />Passout - {passYear}</div>
                    <div className="  flex items-center "><MdOutlineEmail /><p className="text-xs ml-1">{email}</p></div>
                </div>
            </div>
        </>
