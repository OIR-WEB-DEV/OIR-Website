...
const AboutSection = () => {
    return (
        <div className="">
            <div className="grid grid-cols-1 md:grid-cols-[1.2fr_1fr] w-full mt-24">
                ...
                <div className=" p-5 flex items-center justify-center">
                    ...
                    <div className="relative flex">
                        ...
                        <div className="mx-9 w-56 text-white font-medium h-20 absolute -bottom-5 sm:-bottom-5 sm:-left-28 rounded-full flex items-center justify-center bg-oirPurple text-2xl shadow-oirPurple drop-shadow-2xl ">Our Team</div>
