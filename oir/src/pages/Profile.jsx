...
const profile = () => {
  return (
    ...
    <div className='text mt-40 pl-24'>
    <div className='rounded-full w-48 h-48 ring-2 ring-amber-500'><img className='ml-6 pt-2 h-36 w-36' src={prof}></img></div>
    </div>
    </div>
  <section className="h-screen mt-5 lg:mr-20 pr-8">
  <div className="h-full lg:mr-10">
    <div
      ...
      <div className="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
        <h2 className='underline decoration-yellow-500 font-bold text-amber-900 text-2xl mb-7'>Profile</h2>
        <form method='post'>
