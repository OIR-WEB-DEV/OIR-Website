...
const Events = () => {
  return (
    <>
    <h3 className='the-event'>Global Education Fair</h3>
    ...
    <p className='the-para'>
      <h3 className='webinar'>About the webinar:-</h3>
    ...
    {guest.map((item)=>{
      ...
      return <div class="max-w-sm bg-white border border-black-500/100 rounded-lg shadow dark:bg-gray-800 dark:border-black-700 ml-8 mr-2" key={id}>
           ...
           <div class="p-5">
            ...
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400" style={{fontSize:11}}>{info}</p>
            <p style={{fontSize:10,marginLeft:25}}>{date}</p>
            </div>
       </div>
   </div>
    })}
