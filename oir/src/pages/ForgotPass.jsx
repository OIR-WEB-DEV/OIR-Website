                ...
                <div className="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between">
                  ...
                  <div className="bg-gray-100 rounded border flex items-center justify-between mb-10">
                    ...
                    <button
                      ...
                      className="cursor-pointer flex items-center py-2 px-7 rounded-full border-black text-white hover:ring-2 hover:ring-blue-500 justify-center bg-gradient-to-r from-oirYellow to-oirOrange transition duration-100 ease-in-out"
                    >
                      Submit
                    </button>
                  </div>
